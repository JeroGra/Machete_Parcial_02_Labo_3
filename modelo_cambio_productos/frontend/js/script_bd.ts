...
{   
    ...
    tabla += '<tr><th>CÓDIGO</th><th>MARCA</th><th>PRECIO</th><th>FOTO</th><th>TIPO</th><th style="width:110px">ACCIONES</th></tr>';

    if(productos.length == 0)
    {
        tabla += '<tr><td>---</td><td>---</td><td>---</td><td>---</td><td>---</td><th>---</td></tr>';
    }
    else
    {
        productos.forEach((prod : any) => {
            ...
            "<td><img src='"+URL_API+prod.path+"' width='50px' height='50px'></td><td>"+prod.tipo+"</td><th>"+
                            ...
                            <div class="col-md-8">\
                                <form class="was-validated">\
                                    ...
                                    <input type="text" class="form-control" id="tipo" placeholder="Ingresar tipo" name="tipo"\
                                        value="'+tipo+'" '+solo_lectura+' required>\
                                    <div class="valid-feedback">OK.</div>\
                                    <div class="invalid-feedback">Valor requerido.</div>\
                                    </div>\
...
{  
    ...
    form.append("obj", JSON.stringify({"codigo":codigo, "marca":marca, "precio":precio, "tipo":tipo}));
